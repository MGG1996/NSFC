% !TEX Program = xelatex
\documentclass[QingNianC, vlined, timesmath]{nsfc}
...
\begin{document}
	...
	% 具有高级专业技术职务（职称）的申请人是否存在与正在承担的国家自
	\section{前言}
	\subsection{当前版本编译时间}
	\noindent%
	\begin{center}%
